...
import { AsyncStorage, DevSettings, Platform } from 'react-native'
...
export class Reactotron {
  ...
  async setup() {
    ...
    if (__DEV__) {
      ...
      Tron.configure({
        name: this.config.name || APP_NAME || 'app',
      ...
      Tron.onCustomCommand({
        title: `${Platform.OS} ${Platform.Version} Reset Root Store`,
      ...
      Tron.onCustomCommand({
        title: `${Platform.OS} ${Platform.Version} Reset Navigation State`,
      ...
      Tron.onCustomCommand({
        title: `${Platform.OS} ${Platform.Version} Go Back`,
      ...
      Tron.onCustomCommand({
        title: `${Platform.OS} ${Platform.Version} Restart`,
        description: 'Restarts the app',
        command: 'restartApp',
        handler: () => {
          console.tron?.log('Reloading the app')
          DevSettings.reload()
        },
      })
